...
<div id="displayhome" class="jumbotron jumbotron-fluid">
  <div class="container" style="text-align: center;">
    ...
    <a class="btn btn-primary btn-lg nav-link" role="button" href="datetimemanipulation.php"> Date Time Manipulation</a> 
    <a class="btn btn-primary btn-lg nav-link" role="button" href="functions.php"> Functions</a>  
    <br />
    <hr>
  </div>
</div> ---->
